...
def calculate_surplus_data(sales_row):
    ...
    The surplus is described as sales figure subrtacted from the stock:
    - Positive indicates waste
    - Negative indicates extra sandwiches were made
    """
...
def get_last_5_entries_sales():
    ...
    the last 5 entries for each sandwich and returns the data as a lists of list
    """
